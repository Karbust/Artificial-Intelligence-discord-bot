...
module.exports.run = async (prefix, client, message, args, id) => {
	...
	if (!message.channel.permissionsFor(message.guild.me).has('MANAGE_MESSAGES'))
		return sendMSG.sendError(message.channel, "It seems like I'm missing `MANAGE MESSAGES` permission! PLease give me this permission.");
	if (!message.channel.permissionsFor(message.guild.me).has('READ_MESSAGE_HISTORY'))
		return sendMSG.sendError(message.channel, "It seems like I'm missing `READ MESSAGE HISTORY` permission! PLease give me this permission.");
